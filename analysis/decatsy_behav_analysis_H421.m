...
%
%       - file name: if you want to plot results for a specific file
%
%       - phase: if you want to plot data from a certain phase of the experiment
%
...
function []=decatsy_behav_analysis_H421(s_num, sess, arg, validAndCorrectSide)
    ...
    switch experiment_phase
        case {'train1', 'train2', 'train4', 'main'}
            ...
            % suptitle(sprintf('Data for subject %s - phase %s', s_num, expPhase{2}));
